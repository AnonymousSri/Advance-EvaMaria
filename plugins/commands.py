...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('Updates ♻️', url='https://t.me/Bots_LK')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🔵 Our Support Group 🔴', url=f'http://t.me/+UVUxC01f6EYCQCzG')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            InlineKeyboardButton('🔵 Our Support Group 🔴', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('Search 🔎', switch_inline_query_current_chat=''),
            InlineKeyboardButton('Updates ♻️', url='https://t.me/Bots_LK')
            ],[
